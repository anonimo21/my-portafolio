...
public class SkillController {
    ...
    public String showEditForm(@PathVariable Long id, Model model) {
        ...
        if (skillOptional.isPresent()) {
            ...
            model.addAttribute("errorMessage", "No se encontro la habilidad con id: " + id);
            return "redirect:/skills";
        }
    }
    ...
    public String deleteSkill(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("message", "Habilidad eliminada correctamente");
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("error", "No se pudo eliminar la habilidad con id: " + id);
        }
        return "redirect:/skills";
    }
